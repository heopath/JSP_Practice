...
<html>
	...
	<body>
		...
		<a href="/ch05/user1/register5.jsp">등록</a>
		...
		<table border="1">
			...
			<tr>
				...
				<td><%= user1.getAddr() %></td>
				<td>
					<a href="/ch05/user1/modify5.jsp?userid=<%= user1.getUserid()%>">수정</a>
					<a href="/ch05/user1/proc/delete5.jsp?userid=<%= user1.getUserid()%>">삭제</a>
				</td>
			</tr>
			<%
			}

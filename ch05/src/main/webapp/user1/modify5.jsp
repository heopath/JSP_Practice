...
<html>
	...
	<body>
		...
		<a href="/ch05/user1/list5.jsp">목록</a>
		
		<form action="/ch05/user1/proc/modify5.jsp" method="post">
			<table border="1">
				<tr>
					<td>아이디</td>
				...
				<tr>
					<td>성별</td>
					<td><input type="text" name="gender" value="<%= user1.getGender()%>"></td>
				</tr>
				<tr>
					<td>나이</td>
				...
				<tr>
					<td>주소</td>
					<td><input type="number" name="addr" value="<%= user1.getAddr()%>"></td>
				</tr>
				<tr>					

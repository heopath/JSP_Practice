...
<!-- 
	...
	- 일반 접속 커넥션 방식은 사용자가 많아지면 시스템 성능이 떨어지는 단점을 보안
	...
	<Resource
    	...
    	driverClassName="com.mysql.cj.jdbc.Driver"	-- 데이터베이스 드라이버 클래스명
    	url="jdbc:mysql://127.0.0.1:3306/studydb"	-- 데이터베이스 주소
    	username="heocoding"						-- 아이디
    	password="1234"								-- 비밀번호
...
<body>
	<h3>2.DBCP(DataBase Connection Pool)</h3>
